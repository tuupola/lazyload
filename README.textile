...
* Proper fix for "#48":https://github.com/tuupola/jquery_lazyload/pull/48 In some cases initial scroll was needed to display images in viewport. Apparently Webkit browsers sometimes need some time insert images into DOM. 
